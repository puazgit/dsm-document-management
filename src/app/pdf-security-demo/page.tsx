                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className={`p-3 rounded-lg ${['administrator', 'admin', 'manager', 'editor', 'administrator', 'dirut', 'dewas', 'ppd', 'komite_audit', 'gm', 'kadiv', 'manager', 'org_finance', 'org_hrd', 'org_supervisor'].includes(selectedRole) ? 'bg-green-50 border border-green-200' : 'bg-red-50 border border-red-200'}`}>
                          <div className="flex items-center gap-2">
                            <svg className={`w-4 h-4 ${['administrator', 'admin', 'manager', 'editor', 'administrator', 'dirut', 'dewas', 'ppd', 'komite_audit', 'gm', 'kadiv', 'manager', 'org_finance', 'org_hrd', 'org_supervisor'].includes(selectedRole) ? 'text-green-600' : 'text-red-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span className={`text-sm font-medium ${['administrator', 'admin', 'manager', 'editor', 'administrator', 'dirut', 'dewas', 'ppd', 'komite_audit', 'gm', 'kadiv', 'manager', 'org_finance', 'org_hrd', 'org_supervisor'].includes(selectedRole) ? 'text-green-800' : 'text-red-800'}`}>
                              Download Access: {['administrator', 'admin', 'manager', 'editor', 'administrator', 'dirut', 'dewas', 'ppd', 'komite_audit', 'gm', 'kadiv', 'manager', 'org_finance', 'org_hrd', 'org_supervisor'].includes(selectedRole) ? 'Enabled' : 'Restricted'}
                            </span>
                          </div>
                        </div>
                      </div>
